...
$('#source_id').change(function(){
	...
	$('#select').click(function(){
		$.ajax({
			type: "GET",
			async: false,
			url: "/admin.php/purchase/order/get_Mateplan/mateplan/"+pnumber+"/ptype/"+ptype,
...
if(pid){
	$.ajax({
			type: "GET",
			async: false,
			url: "/admin.php/purchase/order/tech/pid/"+pid+"/materials_list/"+materials_list,
			success: function(data){
               ...
               function input(t) {
				...
				$('#source_id').change(function(){
					...
					$.ajax({
						type: "GET",
						async: false,
						url: "/admin.php/purchase/order/get_Detail/source_id/"+source_id,
						success: function(data){
								$('#purchase_type').val(data.leixing);
								$('#purchase_organization').val(data.bumen);
								$('#purchase_uid').val(data.caigouyuan);
