 ...
 */
class Record extends ThinkModel
{
    // 设置当前模型对应的完整数据表名称
    protected $table = '__PERSONNEL_RECORD__';
    ...
    public static function getList($map = '', $order = [])
    {
    	...
    	->view("admin_user", ['username','nickname','avatar','sex','birth','role','organization','position','is_on','status'], 'admin_user.id=personnel_record.uid', 'left')
    ...
    public static function getOne($id = '',$map = [])
    {
    	...
    	->view('admin_organization',['title'=>'organization1'],'admin_organization.id=admin_user.organization','left')
		->view('admin_role',['name'=>'role1'],'admin_role.id=admin_user.role','left')
