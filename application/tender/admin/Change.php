...
use app\tender\model\Change as ChangeModel;
use think\Db;
/**
 *  设计变更
 */
	...
	public function add(){
        ...
        if ($this->request->isPost()) {
            ...
            if ($res = ChangeModel::create($data)) {
                // 记录行为
                flow_detail($data['title'],'tender_change','constructionsite_change','tender/change/detail',$res['id']);
        ...
        return ZBuilder::make('form')
            ...
            ->addFormItems([
                ...
                ['static:6', 'wid', '填报人','',get_nickname(UID)],
 								['select:6','xid', '选择项目', '', db::name('tender_obj')->column('id,name')],
