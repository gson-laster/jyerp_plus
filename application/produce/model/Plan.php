...
class Plan extends ThinkModel
{
    ...
    {
    	$data_list = self::view('produce_plan', true)
    	->view("admin_user", ['nickname'=>'header_name','organization'], 'admin_user.id=produce_plan.uid', 'left')   
    	->view("admin_organization", ['title'=>'org_name'], 'admin_organization.id=admin_user.organization', 'left')
