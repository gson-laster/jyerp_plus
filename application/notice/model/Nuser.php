...
class Nuser extends ThinkModel
{
    ...
    public static function getList($map = [], $order = [])
    {
    	...
    	->view("notice_cate", 'title as cates', 'notice_list.cate=notice_cate.id', 'left')
    ...
    //获取最后一条公告数据
     public static function getLastOne($map = [], $order = '')
    {
    	$data_list = self::view('notice_user', true)    	
    	->view("notice_list", ['title'], 'notice_user.lid=notice_list.id', 'left')
